...
with open(froot+"PopulationInferenceInput/sampleDict_population3_lowSpinAligned.json","r") as jf:
    sampleDict = json.load(jf)

with open(froot+"PopulationInferenceOutput/betaPlusDoubleGaussian2/110623_betaPlusDoubleGaussian2_pop3_300events.json","r") as jf:
...
mcmc.run(rng_key_,sampleDict,injectionDict,False)
mcmc.print_summary()

# Save out data
data = az.from_numpyro(mcmc)
az.to_netcdf(data,"./output/pop3_300_events_fitMasses.cdf")
