...
with open(froot+"PopulationInferenceOutput/betaPlusDoubleGaussian2/110623_betaPlusDoubleGaussian2_pop2_70events.json","r") as jf:
...
az.to_netcdf(data,"./output/pop2_070_events_fitMasses.cdf")
