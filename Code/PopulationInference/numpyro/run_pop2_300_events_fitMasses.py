...
with open(froot+"PopulationInferenceInput/sampleDict_population2_mediumSpin.json","r") as jf:
    sampleDict = json.load(jf)

with open(froot+"PopulationInferenceOutput/betaPlusDoubleGaussian2/110623_betaPlusDoubleGaussian2_pop2_300events.json","r") as jf:
...
az.to_netcdf(data,"./output/pop2_300_events_fitMasses.cdf")
