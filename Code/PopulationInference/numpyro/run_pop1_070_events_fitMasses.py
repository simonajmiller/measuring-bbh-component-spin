...
with open(froot+"PopulationInferenceOutput/betaPlusDoubleGaussian2/110623_betaPlusDoubleGaussian2_pop1_70events.json","r") as jf:
...
az.to_netcdf(data,"./output/pop1_070_events_fitMasses.cdf")
