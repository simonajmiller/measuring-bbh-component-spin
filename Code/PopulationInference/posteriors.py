...
def betaPlusDoubleGaussianJustSpin(c,sampleDict,injectionDict,priorDict): 
    ...
    c : `numpy.array`
        array containing hyper-parameter samples in the order: 
            [ mu_chi, sigma_chi, mu1_cost, sigma1_cost, mu2_cost, sigma2_cost, MF_cost] 
        where 
    ...
    # If the sample falls inside our prior range, continue
        ...
        # Draw probability for component spins
        p_draw_spins = np.asarray(injectionDict['p_draw_a1a2cost1cost2'])
        ...
        # Construct full weighting factors
        det_weights = pdet_spins/p_draw_spins
